      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center min-h-[250px] p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Professionalism</h4>
            ...
            <div className="relative flex flex-col items-center min-h-[250px] p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Responsibility</h4>
              <p className="text-gray-600 text-center">
            ...
            <div className="relative flex flex-col items-center min-h-[250px] p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Guarantee</h4>
              <p className="text-gray-600 text-center">
            ...
            <div className="relative flex flex-col items-center min-h-[250px] p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Experience</h4>
              <p className="text-gray-600 text-center">
