...
function Features() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute left-0 right-0 m-auto w-px p-px h-[100vh] bg-gray-200 transform -translate-y-1/2 rotate-90"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-20 md:pb-16">
            <h1 className="h2 mb-4 text-white">Andromedia Agency</h1>
