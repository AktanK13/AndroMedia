...
function BarGroupHorizontal(_ref) {
  ...
  if (children)
    return import_react14.default.createElement(import_react14.default.Fragment, null, children(barGroups));
...
function BarStackHorizontal(_ref) {
  ...
  if (children)
    return import_react16.default.createElement(import_react16.default.Fragment, null, children(barStacks));
