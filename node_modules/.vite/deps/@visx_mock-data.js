...
// node_modules/@visx/mock-data/esm/generators/getSeededRandom.js
function getSeededRandom(seed) {
  return lcg(seed);
}

// node_modules/@visx/mock-data/esm/generators/genDateValue.js
function genDateValue(length, seed, startTimeMs) {
  ...
  return new Array(length).fill(1).map(function(_, idx) {
    return {
      date: new Date(startDateMs - idx * 36e5),
...
// node_modules/@visx/mock-data/esm/generators/genRandomNormalPoints.js
var sqrt3 = Math.sqrt(3);
function range(length) {
  return new Array(length).fill(1);
}
function genPointsRange(length, _ref, random) {
  var offsetX = _ref[0], offsetY = _ref[1], index = _ref[2];
  if (random === void 0) {
    random = normal_default(0, 0.2);
  }
  return range(length).map(function() {
    return [random() + offsetX, random() + offsetY, index];
  });
}
function genPoints(count, seed) {
  if (count === void 0) {
    count = 300;
  }
  if (seed === void 0) {
  ...
  var random = seed == null ? void 0 : normal_default.source(getSeededRandom(seed))(0, 0.2);
...
// node_modules/@visx/mock-data/esm/generators/genBin.js
var defaultCount = function defaultCount2(idx, number) {
  return Math.random() * (25 * (number - idx));
};
var defaultBin = function defaultBin2(idx, length) {
  return idx * 150;
};
...
// node_modules/@visx/mock-data/esm/generators/genBins.js
...
// node_modules/@visx/mock-data/esm/generators/genPhyllotaxis.js
function genPhyllotaxis(_ref) {
  var radius = _ref.radius, width = _ref.width, height = _ref.height;
...
// node_modules/@visx/mock-data/esm/generators/genStats.js
var defaultRandom = normal_default(4, 3);
var defaultRandomOffset = function defaultRandomOffset2() {
  return Math.random() * 10;
};
var sampleSize = 1e3;
function genStats(number, random, randomOffset) {
  if (random === void 0) {
...
// node_modules/@visx/mock-data/esm/mocks/appleStock.js
var appleStock = [{
...
var appleStock_default = appleStock;

// node_modules/@visx/mock-data/esm/mocks/bitcoinPrice.js
var bitcoinPrice = {
  currency: "USD",
  prices: [{
    price: "2486.69",
...
var bitcoinPrice_default = bitcoinPrice;

// node_modules/@visx/mock-data/esm/mocks/letterFrequency.js
var letterFrequency = [{
  letter: "A",
  frequency: 0.08167
}, {
...
var letterFrequency_default = letterFrequency;

// node_modules/@visx/mock-data/esm/mocks/browserUsage.js
var browserUsage = [{
  date: "2015 Jun 15",
  "Google Chrome": "48.09",
...
var browserUsage_default = browserUsage;

// node_modules/@visx/mock-data/esm/mocks/groupDateValue.js
var groupDateValue = [{
  key: "Group1",
  value: "37",
  date: "04/23/12"
...
var groupDateValue_default = groupDateValue;

// node_modules/@visx/mock-data/esm/mocks/cityTemperature.js
var cityTemperature = [{
  date: "2011-10-01",
  "New York": "63.4",
  "San Francisco": "62.7",
...
var cityTemperature_default = cityTemperature;

// node_modules/@visx/mock-data/esm/mocks/lesMiserables.js
var lesMiserables = {
  nodes: [{
    id: "Myriel",
    group: 1
...
var lesMiserables_default = lesMiserables;

// node_modules/@visx/mock-data/esm/mocks/exoplanets.js
var exoplanets = [{
  name: "Jupiter",
  radius: 10.97,
  distance: 0
...
var exoplanets_default = exoplanets;

// node_modules/@visx/mock-data/esm/mocks/planets.js
var planets = [{
  name: "Jupiter",
  radius: "10.97",
  distance: "0"
...
var planets_default = planets;

// node_modules/@visx/mock-data/esm/mocks/shakespeare.js
var shakespeare = [{
  id: "Shakespeare",
  parent: null,
  size: 0
...
var shakespeare_default = shakespeare;
export {
  appleStock_default as appleStock,
  bitcoinPrice_default as bitcoinPrice,
  browserUsage_default as browserUsage,
  cityTemperature_default as cityTemperature,
  exoplanets_default as exoplanets,
  genBin,
  genBins,
  genDateValue,
  genPhyllotaxis,
  ...
  genStats,
  normal_default as getRandomNormal,
  getSeededRandom,
  groupDateValue_default as groupDateValue,
  lesMiserables_default as lesMiserables,
  letterFrequency_default as letterFrequency,
  planets_default as planets,
  shakespeare_default as shakespeare
};
//# sourceMappingURL=@visx_mock-data.js.map
